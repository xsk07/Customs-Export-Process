...
/* Plugin BizRep_AbsoluteCount_ActivationTrend_Single. 
 ...
 * 2- Apply plugin passing the options object      e.g: $(selector).BizRep_AbsoluteCount_ActivationTrend_Single(myOptions);
...
(function($){   
    ...
    var PLUGIN_TEMPLATE_FILE = "Rep_Tpt_CounterActivationTrend.aspx?absolute=1";

    /* Report name to be shown in error messages" */
    var PLUGIN_NAME = "Count_Activation_Trend_Absolute";


    $.fn.extend({    
           
        
        BizRep_AbsoluteCount_ActivationTrend_Single: function(options) {   
